import numpy as np 
import math 
from renderizer import Triangle
from renderizer import Rasterizer
from renderizer.OBJloader import *
from renderizer.mesh_tools import *
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--angle_x", type=float, default=30.0)
    parser.add_argument("--angle_y", type=float, default=40.0)
    parser.add_argument("--angle_z", type=float, default=0.0)
    parser.add_argument("--screenshot", type=str, default="screenshot.png")
    parser.add_argument("--n_subdivision", type=int, default=3)
    parser.add_argument("--obj_path", type=str, default="./models/spot/Crate/Crate1.obj")
    ...
    for _ in range(args.n_subdivision):
        triangles = mesh_subdivision_loop(triangles)
